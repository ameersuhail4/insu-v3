...
public class ClaimDetails {
    ...
    public ClaimDetails (Policy policy, int estimatedLoss, LocalDate dateOfAccident, boolean claimStatus, Surveyor surveyor, int amtApprovedBySurveyor, boolean insuranceCompanyApproval, int surveyorfees) {
